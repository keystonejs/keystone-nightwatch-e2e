...
module.exports = {
	commands: [{
		 ...
		 * @param {number} header.value The value to use for the test.
		 */
		...
		assertItemFieldUIVisible: function (fields) {
			...
			if (fields) {
				fields.forEach(function (field) {
					...
					if (fieldSelector) {
						var modelTestConfig = new field.modelTestConfig({ formSelector: fieldSelector });
						if (modelTestConfig) {
							...
							if (fieldTestObject) {
								if (fieldTestObject.commands && 'assertListScreenFieldUIVisible' in fieldTestObject.commands) {
									...
									throw new Error('assertItemFieldUIVisible: assertListScreenFieldUIVisible command not defined in ' + field.name + ' field test object!');
								}
							} else {
								throw new Error("assertItemFieldUIVisible: invalid field name!");
							}
						} else {
							throw new Error("assertItemFieldUIVisible: invalid field modelTestConfig!");
						}
					} else {
						throw new Error("assertItemFieldUIVisible: invalid field config row/column!");
					}
				});
			} else {
						...
						if (modelTestConfig) {
							...
							if (fieldTestObject) {
								if (fieldTestObject.commands && 'assertListScreenFieldUINotVisible' in fieldTestObject.commands) {
									...
									throw new Error('assertItemFieldUINotVisible: assertListScreenFieldUINotVisible command not defined in ' + field.name + ' field test object!');
								}
							} else {
								throw new Error("assertItemFieldUINotVisible: invalid field name!");
							}
						} else {
							throw new Error("assertItemFieldUINotVisible: invalid field modelTestConfig!");
						}
					} else {
						throw new Error("assertItemFieldUINotVisible: invalid field config row/column!");
					}
				});
			} else {
				throw new Error("Invalid field specification!");
						...
						if (modelTestConfig) {
							...
							if (fieldTestObject) {
								if (fieldTestObject.commands && 'assertListScreenFieldUIPresent' in fieldTestObject.commands) {
									...
									throw new Error('assertItemFieldUIPresent: assertListScreenFieldUIPresent command not defined in ' + field.name + ' field test object!');
								}
							} else {
								throw new Error("assertItemFieldUIPresent: invalid field name!");
							}
						} else {
							throw new Error("assertItemFieldUIPresent: invalid field modelTestConfig!");
						}
					} else {
						throw new Error("assertItemFieldUIPresent: invalid field config row/column!");
					}
				});
			} else {
				throw new Error("Invalid field specification!");
						...
						if (modelTestConfig) {
							...
							if (fieldTestObject) {
								if (fieldTestObject.commands && 'assertListScreenFieldUINotPresent' in fieldTestObject.commands) {
									...
									throw new Error('assertItemFieldUINotPresent: assertListScreenFieldUINotPresent command not defined in ' + field.name + ' field test object!');
								}
							} else {
								throw new Error("assertItemFieldUINotPresent: invalid field name!");
							}
						} else {
							throw new Error("assertItemFieldUINotPresent: invalid field modelTestConfig!");
						}
					} else {
						throw new Error("assertItemFieldUINotPresent: invalid field config row/column!");
					}
				});
			} else {
				throw new Error("Invalid field specification!");
						...
						if (modelTestConfig) {
							...
							if (fieldTestObject) {
								if (fieldTestObject.commands && 'assertListScreenFieldValueContains' in fieldTestObject.commands) {
									...
									throw new Error('assertItemFieldValueContains: assertListScreenFieldValueContains command not defined in ' + field.name + ' field test object!');
								}
							} else {
								throw new Error("assertItemFieldValueContains: invalid field name!");
							}
						} else {
							throw new Error("assertItemFieldValueContains: invalid field modelTestConfig!");
						}
					} else {
						throw new Error("assertItemFieldValueContains: invalid field config row/column!");
					}
				});
			} else {
				throw new Error("Invalid field specification!");
						...
						if (modelTestConfig) {
							...
							if (fieldTestObject) {
								if (fieldTestObject.commands && 'assertListScreenFieldValueEquals' in fieldTestObject.commands) {
									...
									throw new Error('assertItemFieldValueEquals: assertListScreenFieldValueEquals command not defined in ' + field.name + ' field test object!');
								}
							} else {
								throw new Error("assertItemFieldValueEquals: invalid field name!");
							}
						} else {
							throw new Error("assertItemFieldValueEquals: invalid field modelTestConfig!");
						}
					} else {
						throw new Error("assertItemFieldValueEquals: invalid field config row/column!");
					}
				});
			} else {
				throw new Error("Invalid field specification!");
						...
						if (modelTestConfig) {
							...
							if (fieldTestObject) {
								if (fieldTestObject.commands && 'clickListScreenFieldValue' in fieldTestObject.commands) {
									...
									throw new Error('clickItemFieldValue: clickListScreenFieldValue command not defined in ' + field.name + ' field test object!');
								}
							} else {
								throw new Error("clickItemFieldValue: invalid field name!");
							}
						} else {
							throw new Error("clickItemFieldValue: invalid field modelTestConfig!");
						}
					} else {
						throw new Error("clickItemFieldValue: invalid field config row/column!");
					}
				});
			} else {
				throw new Error("Invalid field specification!");
		...
		assertItemDeleteIconVisible: function (icons) {
			...
			if (icons) {
				...
				throw new Error("Invalid icons specification!");
			}
			return this;
		},
...
function getItemLinkSelector(config) {
	return '.ItemList-wrapper tbody tr:nth-of-type(' + config.itemRow + ') td:nth-of-type(' + (config.fieldColumn) + ') a';
}
