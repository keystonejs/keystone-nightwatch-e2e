...
module.exports = {
	commands: [{
		...
		/**
		 * Asserts that the specified message is showing.
		 *
		 * @param {string} message The message to assert against.
		 */
		...
		/**
		 * Asserts that the specified error message is showing.
		 *
		 * @param {string} message The error message to assert against.
		 */
